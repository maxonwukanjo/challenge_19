...
candidate_database = {
    "Lane": [
        "Lane",
        "0x4e34b5d61361457c0599abC8743d8C40926a8a4F",
        "4.3",
        0.20,
        "Images/lane.jpeg",
    ],
    "Ash": [
        "Ash",
        "0xd60b6E7eF6791A0663FF9B50fA32a38560a525F5",
        "5.0",
        0.33,
        "Images/ash.jpeg",
    ],
    "Jo": [
        "Jo",
        "0x97259Bc2176233D102C902B6B51e3a3BE07CaB13",
        "4.7",
        0.19,
        "Images/jo.jpeg",
    ],
    "Kendall": [
        "Kendall",
        "0x813f1D2836DD64EE70055F6234b1905954c0B980",
        "4.1",
        0.16,
        "Images/kendall.jpeg",
    ],
...
either_balance = get_balance(w3, account.address)
st.sidebar.write(either_balance)
...
# rate from the candidate database (`candidate_database[person][3]`
# ) by the
...
if st.sidebar.button("Send Transaction"):
    ...
    # Your `account`, the `candidate_a`ddress, and the `wage` as parameters
